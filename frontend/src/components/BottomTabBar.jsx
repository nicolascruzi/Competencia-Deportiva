...
const TabCompetencia = ({ active }) => (
  <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={active ? '#38BDF8' : '#6A8AAA'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export default function BottomTabBar({ activeTab, onTab }) {
  ...
  return (
    <>
      {/* Fondo debajo del safe-area */}
      <div style={{ position:'fixed', bottom:0, left:0, right:0, height:'env(safe-area-inset-bottom)', background:'#0A1520', zIndex:59 }} />
